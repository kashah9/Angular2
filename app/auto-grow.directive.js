    ...
    return {
        ...
        execute: function() {
            AutoGrowDirective = (function () {
                // _ <= this defines private variable 
                //_el: ElementRef;
                //creating el and render objetcs of related types, angular would automatically injects instances of 
                // element and renderer into class due to dependency injection
